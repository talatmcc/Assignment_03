...
def show_item(request):
    # items = [
    #     {'id': 1, 'title': 'Pizza', 'description': 'Delicious cheesy pizza'},
    #     {'id': 2, 'title': 'Burger', 'description': 'Juicy grilled burger'},
    #     # Add more items here...
    # ]
    items = [
    {
    ...
    return render(request, 'meal/show_item.html', {'items': items})
